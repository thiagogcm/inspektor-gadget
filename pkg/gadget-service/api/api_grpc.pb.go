...
const (
	OCIGadgetManager_GetOCIGadgetInfo_FullMethodName = "/api.OCIGadgetManager/GetOCIGadgetInfo"
	OCIGadgetManager_RunOCIGadget_FullMethodName     = "/api.OCIGadgetManager/RunOCIGadget"
)
...
func (c *oCIGadgetManagerClient) GetOCIGadgetInfo(ctx context.Context, in *GetOCIGadgetInfoRequest, opts ...grpc.CallOption) (*GetOCIGadgetInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, OCIGadgetManager_GetOCIGadgetInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oCIGadgetManagerClient) RunOCIGadget(ctx context.Context, opts ...grpc.CallOption) (OCIGadgetManager_RunOCIGadgetClient, error) {
	stream, err := c.cc.NewStream(ctx, &OCIGadgetManager_ServiceDesc.Streams[0], OCIGadgetManager_RunOCIGadget_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _OCIGadgetManager_GetOCIGadgetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OCIGadgetManager_GetOCIGadgetInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
