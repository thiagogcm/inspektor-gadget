...
func (s *FileStore) init() error {
	...
	for _, gadget := range gadgets {
		...
		s.instanceMgr.RunGadget(gadget.GadgetInstance.Id, gadget.GadgetInstance.GadgetInfo)
	}
	return nil
}
...
func (s *FileStore) InstallGadgetInstance(ctx context.Context, req *api.InstallGadgetInstanceRequest) (*api.InstallGadgetInstanceResponse, error) {
	...
	s.instanceMgr.RunGadget(req.GadgetInstance.Id, req.GadgetInstance.GadgetInfo)
