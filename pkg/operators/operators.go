...
type ImageOperator interface {
	...
	InstantiateImageOperator(gadgetCtx GadgetContext, descriptor ocispec.Descriptor, params params.Params,
		gadgetParamValues map[string]string) (ImageOperatorInstance, error)
}
...
type DataOperatorInstance interface {
	...
	Prepare(ctx GadgetContext, params *params.Params) error
