...
import (
	...
	ocihandler "github.com/inspektor-gadget/inspektor-gadget/pkg/oci-handler"
	"github.com/inspektor-gadget/inspektor-gadget/pkg/runtime"
)

func (r *Runtime) GetOCIGadgetInfo(gadgetCtx runtime.GadgetContext, params map[string]string) (*api.GadgetInfo, error) {
	ociOp := ocihandler.OciHandler

	opInst, err := ociOp.Instantiate(gadgetCtx, params)
	if err != nil {
...
func (r *Runtime) RunOCIGadget(gadgetCtx runtime.GadgetContext, params map[string]string) error {
	ociHandler := ocihandler.OciHandler

	opInst, err := ociHandler.Instantiate(gadgetCtx, params)
	if err != nil {
