...
type Runtime interface {
	...
	// from a cache
	GetOCIGadgetInfo(gadgetCtx GadgetContext, paramValueMap map[string]string) (*api.GadgetInfo, error)

	RunGadget(gadgetCtx GadgetContext) (CombinedGadgetResult, error)
	RunOCIGadget(gadgetCtx GadgetContext, paramValueMap map[string]string) error
